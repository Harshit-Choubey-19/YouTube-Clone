...
import ytLogo from "../images/y-tube logo.jpg";
    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-14 items-center">
          <img
            className="h-full hidden w-full dark:md:block"
            src={ytLogo}
            alt="Youtube"
          />
          <img
            className="h-7 md:hidden text-black"
            src={ytLogoMobile}
            alt="Youtube"
          />
        </Link>
      ...
      <div className="group flex items-center">
        <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
          <div className="w-10 items-center justify-center hidden group-focus-within:md:flex">
            <IoIosSearch className="text-black text-xl border-black" />
          </div>
          <input
            type="text"
        ...
        <button
          className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1] hover:bg-black/[0.5]"
